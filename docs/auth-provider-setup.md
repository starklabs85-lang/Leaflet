...
Phase 02 uses native Apple and Google identity tokens and exchanges them with Supabase Auth via `signInWithIdToken`.

## Supabase

Enable these providers in the Supabase dashboard:
